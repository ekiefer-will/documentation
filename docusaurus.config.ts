...
// Define the site config with full typing
const config: Config = {
  title: 'documentation',
  ...
  // ✅ Local plugin registration (absolute path based on config file location)
  plugins: [path.join(__dirname, 'plugins', 'docusaurus-plugin-qr')],
